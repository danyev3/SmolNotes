...
namespace SmolNotes
{
    ...
    public class Plugin
    {
        ...
        // public const string HarmonyId = "com.github.YourGitHub.SmolNotes";
        // internal static readonly HarmonyLib.Harmony harmony = new HarmonyLib.Harmony(HarmonyId);

        internal static Plugin Instance { get; private set; }
        internal static IPALogger Log { get; private set; }
        internal static SmolNotesController PluginController { get { return SmolNotesController.Instance; } }
        ...
        */
        ...
        {
            new GameObject("SmolNotesController").AddComponent<SmolNotesController>();
            //ApplyHarmonyPatches();
        }
